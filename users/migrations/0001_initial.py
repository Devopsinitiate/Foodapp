    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('customer', 'Customer'), ('vendor', 'Vendor'), ('driver', 'Driver'), ('admin', 'Admin')], default='customer', help_text='Type of user account', max_length=10)),
                ...
                ('is_active_vendor', models.BooleanField(default=False, help_text='Whether vendor account is approved and active')),
                ('is_available_driver', models.BooleanField(default=False, help_text='Whether driver is currently available for deliveries')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('favorite_cuisines', models.JSONField(blank=True, default=list, help_text='List of favorite cuisine types')),
                ('dietary_restrictions', models.JSONField(blank=True, default=list, help_text='Dietary restrictions (vegetarian, vegan, etc.)')),
